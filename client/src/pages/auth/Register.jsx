    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            <form
                ...
                <div className="flex items-center mt-6 w-full bg-gray-50 ring-2 ring-gray-200 focus-within:ring-indigo-500 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <div className="flex items-center w-full mt-4 bg-gray-50 ring-2 ring-gray-200 focus-within:ring-indigo-500 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <button type="submit" className="mt-6 w-full h-11 rounded-full text-white bg-indigo-600 hover:bg-indigo-700 transition " >
                    Sign up
                </button>

                <p className="text-gray-600 text-sm mt-3 mb-11" >
                    Already have an account?
                    <span className="text-indigo-600 hover:underline ml-1 cursor-pointer">Login here</span>
                </p>
            </form>
            {/* Soft Backdrop*/}
